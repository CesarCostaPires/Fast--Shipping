...
import { BotaoFlat, Container, Footer, Header, Icones, Nome, TextoFlat, TextoIcones, TextoIconeSelecionado, TextoTitulo, Titulo, ViewFlat2, Modalzinho } from "../Style";
...
export default function Motorista(){
    ...
    return(
        <Container>
            ...
            <Titulo>
                <TextoTitulo>          Suas entregas</TextoTitulo>
            </Titulo>
            <ViewFlat2>
                <FlatList 
                    data={entregas}
